...
def send_reminder_emails():
    ...
    for reminder in reminders:
        reminder_id, title, description, first_reminder_date_str, reminder_frequency = reminder

        # Convert the first_reminder_date string to a date object
        first_reminder_date = date.fromisoformat(first_reminder_date_str)
